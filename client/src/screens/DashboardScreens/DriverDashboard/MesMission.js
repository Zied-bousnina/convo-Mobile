...
//   handleNotyfy(newMessage);
  ...
  const renderItem2 = useCallback(({ item }) => <ListRequest2 disable key={uniqueId()} data={item} />,[])
 ...
 <Icon
  ...
  />
    ...
    {/* Press me */}
      ...
      {item_list?.length !=0 || missionTerminee?.length!=0 ? (
        <>
          <View
            style={{
              // flex: 1,
