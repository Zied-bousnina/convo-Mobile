...
// console.log(image? 'data:image/png;base64'+image : null)
  ...
  <Text style={styles.title}>Photo of your vehicle</Text>
...
<View style={styles.textCon}>
  ...
  // }}
  source={image.frontDriver? {uri:image.frontDriver?.uri}:require('../../../../assets/images1/car.png')}
