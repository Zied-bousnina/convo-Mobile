...
// console.log(image? 'data:image/png;base64'+image : null)
  ...
  const handleCreateDriverLicense = async (values, formikActions)=> {
    ...
    formData.append('assurance', {
      uri: image?.assurance ? image?.assurance?.uri : `https://png.pngtree.com/png-clipart/20230824/original/pngtree-drivers-license-driver-card-id-picture-image_8407548.png`,
      type: 'image/jpg',
  ...
  <Text style={styles.title}>Certificat d'assurance<Text style={{fontSize:18, fontWeight:"400", color:"#ccc"}}></Text></Text>
...
<View style={styles.textCon}>
  ...
  //   uri:image.assurance? image.assurance?.uri:"https://png.pngtree.com/png-clipart/20230824/original/pngtree-drivers-license-driver-card-id-picture-image_8407548.png"
  // }}
  source={image.assurance? {uri:image.assurance?.uri}:require('../../../assets/images1/driveCard.png')}
...
btnName={image.assurance ?"Edit Photo" : "Add a photo"}
onPress={()=>selectPhotoTapped("assurance")}
/>
</View>
